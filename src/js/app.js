          ...
          <ul class="${variables.socialMediaPosition}">
            ...
            ${
              linkedin
                ? `
              <li>
                <a href="https://linkedin.com/${linkedin}"><i class="fab fa-linkedin"></i></a> </li>`
                : ""
            }
            ${
              instagram
                ? ` 
              <li><a
                  href="https://instagram.com/${instagram}"><i class="fab fa-instagram"></i></a></li>`
                : ""
            }
          </ul>
        </div>
